...
//
//  Le bouton "Planifier une SAE" utilise exactement la même
//  modale 2 phases que le bouton "Nouvelle SAE" de SAEList.
//  C'est juste un raccourci — zéro duplication de code.
// ============================================================
    ...
    <PageLayout title="Tableau de bord">
      <div style={{ display: "flex", flexDirection: "column", gap: isMobile ? 14 : 20 }}>
        ...
        <div style={{
          ...
          {/* Bouton Planifier une SAE → ouvre CreationModal */}
          <div
          ...
          <div style={{
            ...
            <h2 style={{
              ...
              fontWeight: 800, color: "#1a1a2e", marginBottom: 12,
            }}>
              Messages
            </h2>
            {MESSAGES.map(m => (
        ...
        <div style={{ display: "grid", gap: 16, gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr" }}>
          ...
          <div style={{ background: "#ede9fb", borderRadius: 18, padding: 20 }}>
            <h2 style={{
              fontFamily: "'Syne',sans-serif", fontSize: 17,
              fontWeight: 800, color: "#1a1a2e", marginBottom: 14,
            }}>
              Avancée des groupes
            </h2>
            ...
            {QUICK_STATS.map(s => (
              <div key={s.label} style={{
                ...
                <span style={{
                  ...
                  color: s.color, fontFamily: "'Syne',sans-serif",
                }}>
                  {s.value}
                </span>
              </div>
      ...
      {/* Modale création SAE — identique à "Nouvelle SAE" dans SAEList */}
      {showModal && (
