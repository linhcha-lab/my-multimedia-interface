...
// Helpers
const _roleLabel = (role) => role === "prof" ? "Professeur" : "Étudiant MMI"
const _roleColor = (role) => role === "prof" ? "#0369a1" : "#7c3aed"
const _roleBg = (role) => role === "prof" ? "#e0f2fe" : "#f0ebff"
...
return ( <PageLayout title="Messagerie">
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 8,
                border: "none",
                background: filtre === f.key ? "#7c3aed" : "#eee",
          ...
          {selected.messages.map(msg => (
            <div
              ...
              style={{
                ...
                background: msg.from === "me" ? "#7c3aed" : "#eee",
