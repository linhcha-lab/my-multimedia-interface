...
function sliderToColor(val) {
  // val 0–100 → spectre de couleurs
  const h = Math.round(val * 3.6) // 0→360
        ...
        {image ? (
          ...
          <div style={{
            ...
            <span style={{ fontSize: 12, fontWeight: 500 }}>
              {large ? "Photo principale" : "Ajouter"}
            </span>
          </div>
        )}
      </div>
...
export default function PublierSAE() {
  ...
  const [choixAuteur, setChoixAuteur]   = useState("moi") // "moi" | "groupe"
  const [groupeId, setGroupeId]         = useState(1)
  const [couleurFond, setCouleurFond]   = useState(50)   // 0–100 → hue
  const [couleurTexte, setCouleurTexte] = useState(0)    // 0–100 → hue
  ...
  const handleAddPdf = (e) => {
    ...
    setPdfFiles(prev => [
      ...prev,
      ...files.map(f => ({ file: f, name: f.name, selected: false }))
    ])
    e.target.value = ""
  }
  ...
  return (
    <PageLayoutStudent title="Publier une SAE">
      ...
      <div style={{
        ...
        // gap: 20,
        // padding: "0 16px 60px", // padding sur mobile
        }}>
        ...
        <SectionCard>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
            {SEMESTRES.map(s => (
              <div key={s} className="chip-semestre">
                <input
                  type="checkbox" id={`sem-${s}`}
                  checked={semestre === s}
                  onChange={() => {
                    setSemestre(semestre === s ? null : s)
                    setSae(null) // reset SAE quand semestre change
                  }}
                />
                <label htmlFor={`sem-${s}`}>
          ...
          {/* SAEs du semestre sélectionné */}
          {semestre && (
            <div style={{ marginTop: 22 }}>
              <div style={{
                fontFamily: "'Syne',sans-serif", fontWeight: 700,
                fontSize: 14, color: "#221A47", marginBottom: 12,
              }}>SAE</div>
              <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
                {SAE_PAR_SEMESTRE[semestre].map(sae => (
                  <div key={sae} className="chip-sae">
                    <input
                      type="radio" id={`sae-${sae}`} name="sae"
          ...
          <div style={{ position: "relative" }}>
            <input
              ...
              style={{
                ...
                background: "#f5f4f8", borderRadius: 12,
                padding: "14px 52px 14px 18px",
                fontSize: 15, color: "#221A47",
                outline: errors.titre ? "2px solid #ef4444" : "2px solid transparent",
            ...
            <span style={{
              ...
              fontSize: 11, color: titre.length > 50 ? "#ef4444" : "#bbb", fontWeight: 600,
            }}>
              {titre.length}/60
            </span>
          </div>
        ...
        <SectionCard>
          ...
          <div style={{ display: "flex", alignItems: "flex-start", gap: 20, flexWrap: "wrap" }}>
            ...
            {/* Option : moi seul */}
            <div
              className="etudiant-choice"
              onClick={() => setChoixAuteur("moi")}
              style={{
            ...
            <div style={{ flex: 1, minWidth: 200 }}>
              ...
              >
                <div style={{ fontWeight: 700, fontSize: 14, color: "#221A47", marginBottom: 6 }}>
                  {monGroupe?.nom}
                </div>
        ...
        <SectionCard>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
              <span style={{ fontSize: 14, color: "#555", minWidth: 130 }}>Fond de la page :</span>
              <div style={{ flex: 1 }}>
                <input
                  type="range" min={0} max={100} value={couleurFond}
                  onChange={e => setCouleurFond(Number(e.target.value))}
                  style={{
                    width: "100%",
                    background: `linear-gradient(to right,
                      hsl(0,85%,52%),hsl(36,85%,52%),hsl(72,85%,52%),
                      hsl(108,85%,52%),hsl(144,85%,52%),hsl(180,85%,52%),
                      hsl(216,85%,52%),hsl(252,85%,52%),hsl(288,85%,52%),
                      hsl(324,85%,52%),hsl(360,85%,52%))`,
                  }}
                />
              </div>
              <div style={{
                ...
                background: bgColor,
                boxShadow: `0 4px 16px ${bgColor}88`,
            ...
            {/* Texte */}
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
              <span style={{ fontSize: 14, color: "#555", minWidth: 130 }}>Couleur du texte :</span>
              <div style={{ flex: 1 }}>
                <input
                  type="range" min={0} max={100} value={couleurTexte}
                  onChange={e => setCouleurTexte(Number(e.target.value))}
                  style={{
                    width: "100%",
                    background: `linear-gradient(to right,
                      hsl(0,85%,52%),hsl(36,85%,52%),hsl(72,85%,52%),
              ...
              <div style={{
                ...
                boxShadow: `0 4px 16px ${textColor}88`,
                flexShrink: 0, transition: "background .1s",
                border: "3px solid #fff",
              }} />
            </div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
              ...
              <div style={{
                ...
                fontFamily: "'Syne',sans-serif",
                boxShadow: `0 6px 20px ${bgColor}66`,
        ...
        <SectionCard>
          ...
          <div>
            <div style={{
              ...
              <span style={{
                fontSize: 11, background: "#f0ebff", color: "#7c3aed",
            ...
            <div style={{
              ...
              {photosSecond.map((ph, i) => (
                <PhotoSlot
                  ...
                  label={`Photo ${i + 1}`}
                  image={ph}
                  onChange={val => updatePhotoSecond(i, val)}
                  required={true}
                />
              ))}
            </div>
        ...
        <SectionCard>
          ...
          {pdfFiles.length === 0 ? (
            <div style={{
              ...
              border: "2px dashed #e0daf0", borderRadius: 12,
            }}>
