...
export default function StudentSettings() {
  ...
  return (
    <PageLayoutStudent title="Paramètres">
      ...
      <div style={{ maxWidth: 600 }}>
        ...
        <Section title="Informations personnelles">
          ...
          <button onClick={() => alert("Profil sauvegardé !")} style={{
            padding: "10px 22px",
            borderRadius: 12,
            border: "none",
            background: "linear-gradient(135deg,#7c3aed,#9d5cf5)",
        ...
        <Section title="Mot de passe">
          ...
          <button onClick={() => alert("Mot de passe modifié !")} style={{
            padding: "10px 22px",
            borderRadius: 12,
            border: "none",
            background: "linear-gradient(135deg,#7c3aed,#9d5cf5)",
