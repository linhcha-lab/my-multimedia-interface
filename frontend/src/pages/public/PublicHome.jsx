// ============================================================
//  pages/public/PublicHome.jsx — Fidèle à la maquette, responsive
// ============================================================
...
const PROJETS = [
  {
    ...
    Illus: () => (
      <div style={{
        ...
        {/* Téléphone */}
        <div style={{
          width:62,height:122,background:"#0f172a",borderRadius:13,
          border:"2px solid #334155",display:"flex",flexDirection:"column",
          alignItems:"center",justifyContent:"space-between",padding:"7px 5px",
          zIndex:2,transform:"rotate(-8deg)",boxShadow:"0 24px 44px rgba(0,0,0,.55)",
        }}>
        ...
        {/* Reflets */}
        <div style={{position:"absolute",top:10,right:12,width:30,height:30,borderRadius:"50%",background:"rgba(255,255,255,.06)"}} />
      </div>
    ),
  },
  {
...
function ProjetCard({ projet, delay = 0 }) {
  ...
  return (
    ...
    >
      ...
      {/* Auteur */}
      <div style={{fontSize: 12, color: "#3d3360", marginBottom: 2, fontWeight: 500}}>
        {projet.auteur}
      </div>

      {/* Date */}
      <div style={{fontSize: 12, color: "#7a6a9a", marginBottom: 16}}>
        {projet.date}
      </div>
...
function SectionMMI({ isMobile, isTablet }) {
  return (
    <section style={{
      background: C.violet,
      padding: isMobile ? "60px 20px 56px" : isTablet ? "64px 36px 60px" : "72px 60px 68px",
    }}>
      {/* Titre */}
      <h2 style={{
        fontFamily: "'Syne',sans-serif",
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            whiteSpace: "nowrap",
            boxShadow: "0 4px 14px rgba(212,255,0,.4)",
          }}>
          ...
          <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:10}}>
            <svg width={isMobile?110:130} height={isMobile?110:130} viewBox="0 0 100 100">
              {/* Fond sombre = 60% cours pratiques */}
              <circle cx="50" cy="50" r="50" fill={C.navy} />
              {/* Secteur jaune = 40% cours théoriques (144°) */}
              <path
        ...
        <div style={{
          ...
          <div style={{
            background: C.lilas, borderRadius:12,
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{display:"flex",gap:12,justifyContent:"center",flexWrap:"wrap"}}>
            <div style={{
              background:C.lilas,borderRadius:10,
              padding:"12px 28px",fontSize:14,
              fontWeight:800,color:C.violet,letterSpacing:.5,
            }}>STAGE</div>
            <div style={{
              background:C.jaune,borderRadius:10,
              padding:"12px 20px",fontSize:14,
              fontWeight:800,color:C.navy,letterSpacing:.5,
            }}>ALTERNANCE</div>
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{display:"flex",alignItems:"center",gap:10,flexWrap:"wrap"}}>
            <div style={{display:"flex",gap:5,flexShrink:0}}>
              <img
                src="https://flagcdn.com/w40/pt.png" alt="Portugal"
                style={{width:38,height:26,objectFit:"cover",borderRadius:4,boxShadow:"0 2px 6px rgba(0,0,0,.15)"}}
                onError={e=>e.target.style.display="none"}
              />
              <img
                src="https://flagcdn.com/w40/ca.png" alt="Canada"
                style={{width:38,height:26,objectFit:"cover",borderRadius:4,boxShadow:"0 2px 6px rgba(0,0,0,.15)"}}
                onError={e=>e.target.style.display="none"}
              />
            </div>
            <div style={{
              background:C.jaune,borderRadius:30,
...
function SectionFAQ({ isMobile }) {
  ...
  return (
    <section style={{
      background: "#0d0d0d",
      padding: isMobile ? "64px 20px 80px" : "90px 60px 100px",
    }}>
      <div style={{
        display:"grid",
        ...
        <div style={{order: isMobile ? 1 : 2}}>
              ...
              >
                <button
                  ...
                  style={{
                    ...
                    gap:12,padding:"10px 14px 10px 10px",
                  }}
                >
          ...
          <div style={{
            ...
            <button style={{
              ...
              border:`1.5px solid rgba(34,26,71,.25)`,
              background:"transparent",
              display:"flex",alignItems:"center",justifyContent:"center",
              color:C.navy,fontSize:16,
              transition:"background .15s",
            }}
              onMouseEnter={e=>e.currentTarget.style.background="rgba(34,26,71,.08)"}
...
export default function PublicHome() {
  ...
  return (
    <>
      ...
      <header style={{
        ...
        <button
          ...
          style={{
            ...
            fontSize: isMobile ? 12 : 13,
            fontWeight:700,zIndex:3,flexShrink:0,
        ...
        {/* Logo centré — remplace /assets/logo-mmi.png par ton vrai chemin */}
        <div style={{
        ...
        {!isMobile && (
          <div style={{position:"relative",width:140,height:120,zIndex:1,flexShrink:0}}>
            ...
            {/* Petit point jaune */}
            <div style={{
              position:"absolute",right:18,top:82,
      ...
      {/* ══════════════════════════════════════
          2. HERO — citation + titre
      ══════════════════════════════════════ */}
      <section style={{
        background:C.violet,
        padding: isMobile ? "32px 24px 52px" : "36px 80px 64px",
        textAlign:"center",
      }}>
        <h1 style={{
          fontFamily:"'Syne',sans-serif",
      ...
      <section style={{
        ...
        {isMobile ? (
          ...
          /* Desktop / tablet : rangée avec stagger vertical */
          <div style={{
            display:"flex",
            gap: isTablet ? 16 : 22,
            alignItems:"flex-start",
            ...
            {PROJETS.map((p, i) => (
              <div
                ...
                style={{
                  marginTop: i === 0 ? 0 : i === 1 ? 38 : 72,
                  flex: isTablet ? "0 0 270px" : "0 0 300px",
      ...
      {/* ══════════════════════════════════════
          4. CTA — Voir tous les projets
      ══════════════════════════════════════ */}
      <section style={{
        background:"#5b21b6",
        padding: isMobile ? "72px 20px" : "90px 44px",
        textAlign:"center",
        position:"relative",
        overflow:"hidden",
        ...
        {/* Cartes fantômes (desktop uniquement) */}
        {!isTablet && [
          {l:"2%",  t:"2%",   w:78, h:108,deg:"-14deg"},
          {l:"9%",  t:"44%",  w:62, h:88, deg:"9deg"},
          {l:"17%", t:"-8%",  w:70, h:98, deg:"-5deg"},
          {l:"26%", t:"30%",  w:56, h:76, deg:"5deg"},
          {r:"2%",  t:"4%",   w:78, h:108,deg:"13deg"},
          {r:"10%", t:"46%",  w:62, h:88, deg:"-8deg"},
          {r:"18%", t:"-9%",  w:70, h:98, deg:"4deg"},
          {r:"27%", t:"28%",  w:56, h:76, deg:"-5deg"},
        ].map((s,i) => (
          <div key={i} style={{
            position:"absolute",
            left:s.l,right:s.r,top:s.t,
